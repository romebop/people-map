import { ChangeEvent, FC, MutableRefObject, useContext, useEffect, useState } from 'react';
...
//   useEffect(() => {
//     if (div) div.innerText = note.content;
...
//           payload: { personId, noteId: note.id, content: (div!.innerText) },
//         })}
//       >{div ? (div as HTMLDivElement).innerText : null}</NoteContent>
//     </Container>
//   );
// };
